...
export default function WelcomePage() {
  ...
  const yText = useTransform(scrollY, [0, 200, 300, 500], [0, 50, 50, 350])
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{ opacity, y: YCity }}
          src={cityImg}
          alt="A city skyline touched by sunlight"
          id="city-image"
        />
        <motion.img style={{ opacity: heroOpacity, y: yHero }} src={heroImg} alt="A superhero wearing a cape" id="hero-image" />
      </header>
